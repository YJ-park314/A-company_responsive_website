...
<!-- <div id="faq_wrap" class="faq_<?php echo $fm_id; ?>"> -->
    ...
    <section id="faq_con" class="faq">
        ...
        <div class="faq-wrap">
            <div class="left">
                <div class="subject-ko"><?php echo conv_content($fm['fm_head_html'], 1); ?></div>
                <p class="subject-en"><?php echo $g5['title']; ?></p>
                <ul class="faq-list">
                    <?php
                    $idx = 0;
                    ...
                    <li class="<?php if($idx == 0) echo 'active'; ?>">
                        <h4 class="tit">
                            <a href="#none" onclick="return faq_open(this);"><span class="q-shape">Q</span><?php echo conv_content($v['fa_subject'], 1); ?></a>
            ...
            <div class="right">
                <?php if ($timg_src) echo '<div id="faq_timg" class="faq_img"><img src="'.$timg_src.'" alt=""></div>'; ?>
            </div>
        </div>
    </section>
    <?php
...
<script>
    ...
    ScrollTrigger.create({
        ...
        trigger:"#faq_con",
        toggleClass:{targets: '#faq_con .faq-summary', className:'fade-motion'},
        once: true,
    });
</script>