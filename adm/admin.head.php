...
<header id="hd">
    ...
    <div id="hd_top">
        <button style="display:none" type="button" id="btn_gnb" class="btn_gnb_close <?php echo $adm_menu_cookie['btn_gnb']; ?>">메뉴</button>
        ...
        <div id="tnb">
            <ul style="display:none">
                ...
                <li class="tnb_li" style="display:none"><a href="<?php echo G5_ADMIN_URL ?>/service.php" class="tnb_service">부가서비스</a></li>
    ...
    <nav id="gnb" style="display:none" class="gnb_large <?php echo $adm_menu_cookie['gnb']; ?>">
        <h2>관리자 주메뉴</h2>
        <ul class="gnb_ul">
            <?php
            $jj = 1;
