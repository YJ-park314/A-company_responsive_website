...
<!-- Contact us 고정 아이콘 -->
<!-- <a href="#" class="contact-btn" onclick="alert('해당 페이지는 현재 준비중입니다.'); return false;">
    <span class="hidden">Contact us</span>
    <img src="/theme/basic/img/ico_contact_asterisk.svg" alt="">
    <img src="/theme/basic/img/contact_btn.svg" alt="">
</a> -->
...
<article id="main">
                ...
                <li class="swiper-slide">
                    ...
                    <div class="right">
                        ...
                        <dl class="subtitle">
                            ...
                            <dd class="line"></dd>
                            <dd>에이프릴마치는<br class="mo"> 마케팅에 직접적으로<br class="pc">도움이 될 수 있는 디자인의 정확한 방향을 제시합니다</dd>
                        </dl>
                    </div>
                </li>
                <li class="swiper-slide">
            ...
            <ul class="business-tabs">
                ...
                <li class="active tab-con">
                    <div class="con-wrap">
                        ...
                        <dl class="subtitle">
                            ...
                            <dd>에이프릴마치는 체계적인 컨설팅과 전략적인 디자인으로 브랜드를 지원합니다<br class="pc">에이프릴마치에서 국가 지원 사업 을 시작해보세요</dd>
                        </dl>
                ...
                <li class="tabs">
                    <a href="#">
                        ...
                        <ul class="business-tags">
                            <li class="pc">컨설팅 부터 마케팅까지 풀케어</li>
                            <li>브랜딩</li>
                            <li class="mo no-tag">・</li>
                            <li class="pc">웹 사이트</li>
                            <li class="pc">편집・홍보물</li>
                ...
                <li class="tab-con">
                    <div class="con-wrap">
                        ...
                        <dl class="subtitle">
                            ...
                            <dd>에이프릴마치는 디자인・ 브랜딩・ 마케팅 캠페인에 이르는<br class="pc">Full Service Creative로 고객사를 지원합니다</dd>
                        </dl>
                        <a href="#" class="read-more" onclick="alert('해당 페이지는 현재 준비중입니다.'); return false;">Read more<img src="/theme/basic/img/ico_more_arrow.svg" alt="화살표 아이콘"></a>
                        <div class="swiper-container">
                            <ul class="swiper-wrapper">
                ...
                <li class="tab-con">
                    <div class="con-wrap">
                        ...
                        <dl class="subtitle">
                            <dt>한눈에 알기 쉬운 운영・분석・결과<br><strong>기업별 맞춤형 IT 대시보드</strong></dt>
                            <dd>지속적인 실시간 정보 리포팅을 대시보드 용도에 맞춰 기획하며・<br class="pc">시각적 데이터를 적시성을 강조해 대시보드를 제작합니다</dd>
                        </dl>
                ...
                <li class="tab-con">
                    <div class="con-wrap">
                        ...
                        <dl class="subtitle">
                            <dt>「서울시」ㆍ「인천시」 공식 수행기관 선정<br><strong>공공기관 운영/관리 경험 多</strong></dt>
                            <dd>디자인 실행 업무를 넘어・ 사업주최와 참여기관이 이원화 된 과업의<br class="pc">풍부한 운영 경험에서 쌓아온 노하우로 모두가 만족하는 결과물 창출하겠습니다.</dd>
                        </dl>
                        <a href="#" class="read-more" onclick="alert('해당 페이지는 현재 준비중입니다.'); return false;">Read more<img src="/theme/basic/img/ico_more_arrow.svg" alt="화살표 아이콘"></a>
                        <div class="swiper-container">
                            <ul class="swiper-wrapper">
    ...
    <section class="our-purpose">
        ...
        <ul class="purpose-list">
            <li>
                <div class="motion">
                    <div class="wrap"><img class="temp" src="/theme/basic/img/main/mot1.svg" alt=""></div>
                ...
                <div class="txt">
                    ...
                    <dl>
                        ...
                        <dd>
                            ...
                            <p>타당한 논리적 접근으로 유연한 소통의 방식으로 브랜드스러움을 설계합니다</p>
                        </dd>
                    </dl>
                </div>
            </li>
                ...
                <div class="txt">
                    ...
                    <dl>
                        ...
                        <dd class="strong">
                            ...
                            <p>만족스러울 수 있는 디자인 경험을 만들고자 합니다</p>
                        </dd>
                        <dd>
                            <p>우리는 디자인과 마케팅 전략을 통합적 관점에서 접근하여</p>
                            <p>미디어의 특성에 따라 변화하는 디자인 컨텐츠 개발로</p>
                            <p>시대를 리딩하고 고객의 마음을 사로잡는 디자인 혁신을 만들겠습니다</p>
                        </dd>
                    </dl>
                </div>
                <div class="motion">
                    <div class="wrap"><img class="temp" src="/theme/basic/img/main/mot2.svg" alt=""></div>
                    <div class="wrap" style="display: none;">
            ...
            <li>
                <div class="motion">
                    <div class="wrap"><img class="temp" src="/theme/basic/img/main/mot3.svg" alt=""></div>
                    <div class="wrap" style="display: none;">
                        <div class="track">
                ...
                <div class="txt">
                    ...
                    <dl>
                        ...
                        <dd>
                            <p>브랜드 키 비주얼을 활용한 온/오프라인 디자인 제작부터</p>
                            <p>사용자 중심 웹사이트 개발과 온라인 마케팅으로</p>
            ...
            <li class="dom-txt">
                <dl class="subtitle">
                    ...
                    <dd>
                        ...
                        <p>고객사에게는 든든한 믿음을 소비자에게는 새로운 기쁨을 전달합니다</p>
                        <p><strong>에이프릴마치 M&C는 모든 순간 순간을 늘 단단한 마음으로 준비하며 최선을 다합니다</strong></p>
                    </dd>
                </dl>
            </li>
        </ul>
