...
define('G5_MYSQL_HOST', 'db.aprilmarch.co.kr');
define('G5_MYSQL_USER', 'aprilmarch');
define('G5_MYSQL_PASSWORD', '29250662ch!!');
define('G5_MYSQL_DB', 'dbaprilmarch');
define('G5_MYSQL_SET_MODE', false);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '638d8f6733f9301e4b972c2509352c19'); // 토큰 암호화에 사용할 키
